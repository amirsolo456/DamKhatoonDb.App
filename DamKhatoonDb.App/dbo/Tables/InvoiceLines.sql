CREATE TABLE [dbo].[InvoiceLines] (
    ...
    CONSTRAINT [FK_InvoiceLines_Invoices] FOREIGN KEY ([Id]) REFERENCES [dbo].[Invoices] ([Id]),
    CONSTRAINT [FK_InvoiceLines_Persons] FOREIGN KEY ([Id]) REFERENCES [dbo].[Persons] ([Id])
);
